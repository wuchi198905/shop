        ...
        for(int i=0;i<aee.length;i++){
            AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                    ...
                    new StrategyConfig()
                            ...
                            .setInclude(new String[] { aee[i] }) // 需要生成的表
                            ...
                            // 自定义 controller 父类
                            //.setSuperControllerClass("com.example.canggang.base.controller.BaseController")
                    ...
                    new PackageConfig()
                            //.setModuleName("User")
                            .setParent("com.example.shop.management")// 自定义包路径
